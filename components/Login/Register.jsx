    ...
    return (
        <div className="w-full min-h-screen flex flex-col bg-[#edf2f8]  justify-start items-center py-24 ">
            ...
            <form onSubmit={handleRegister} className='w-5/6 md:w-4/12 bg-[#f9fbfc] mt-8 py-8 border  rounded-3xl px-2 flex flex-col items-center'>
                ...
                <button type="submit" className="w-40 mt-4 rounded-xl shadow-md py-2  bg-[#436850] text-lg text-white">{postloader ? <div className='loading-circul'></div> : "sign up"}</button>
                <a href="/login" className=" underline mt-4 text-[#436850]"> login</a>
            </form>
