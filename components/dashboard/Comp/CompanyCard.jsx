...
const CompanyCard = ({comp}) => {
    return (
        ...
        <a href={"/dashboard/companies/"+comp.id} className=' absolute text-primary-1 m-6 top-0 right-0'>visit</a>
            <div class="flex items-center gap-5">
                ...
                <div class="grid gap-1">
                    <h5
                        ...
                        {comp?.name}</h5>
                    <span class="text-sm leading-6 text-gray-500">{comp?.address}</span>
