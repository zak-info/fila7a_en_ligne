            ...
            <div class="mx-auto max-w-screen-lg px-4 2xl:px-0">
                    ...
                    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-primary-600 dark:text-gray-400 dark:hover:text-white md:ms-2">company page</a>
                            </div>
                        </li>
                    ...
                    <div class="mb-4 grid gap-4 sm:grid-cols-2 sm:gap-8 lg:gap-16">
                        <div class="space-y-4">
                            <div class="flex space-x-4">
                                ...
                                <div>
                                    ...
                                    <h2 class="flex items-center text-xl font-bold leading-none text-gray-900 dark:text-white sm:text-2xl">{currentComp?.name}</h2>
                                </div>
                            </div>
                            <dl class="">
                        ...
                        <div class="space-y-4">
                            <dl>
                                ...
                                <dd class="text-gray-500 dark:text-gray-400">{currentComp?.phone}</dd>
                            </dl>
                            <dl>
                ...
                <div class="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800 md:p-8">
                    ...
                    <div class="flex flex-wrap items-center gap-y-4 pt-4 md:pt-5">
                        ...
                        <dl class="w-1/2 sm:w-1/5 md:flex-1 lg:w-auto">
                            <dt class="text-base font-medium text-gray-500 dark:text-gray-400">Price:</dt>
                            <dd class="mt-1.5 text-base font-semibold text-gray-900 dark:text-white">756.00 DZD</dd>
                        </dl>
