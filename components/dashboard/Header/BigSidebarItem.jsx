...
const BigSidebarItem = ({ href, icon, span, path }) => {
    ...
    return (
        <>
            <a href={href} className={`w-full ${path == current_path ? "bg-primary-2" : "bg-none"} flex items-center px-[12px] py-[12px] gap-2 rounded-r-full shadow-md shadow-inherit bg-primary-2-hover transition-all ease-in-out duration-150 `}>
