                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 mx-auto max-md:px-2 ">
                    <div class="img">
                        <div class="img-box h-full max-lg:mx-auto ">
                            <Image placeholder='blur' blurDataURL={product?.base64Placeholder} width={1980} height={1080} src={product?.imageUrl} alt="Yellow Tropical Printed Shirt image"
                        ...
                        <div class="data w-full max-w-xl">
                            ...
                            <ul class="grid gap-y-4 mb-8">
                                ...
                                <li class="flex items-center gap-3">
                                    ...
                                    <span class="font-normal text-base text-gray-900 ">{product?.price + "  "} DZD
                                        {/* 40% */}
                                    </span>
                                </li>
                                {/* <li class="flex items-center gap-3">
