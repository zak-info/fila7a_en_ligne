...
const ProductsCard = ({product}) => {
    ...
    return (
        <div class=" w-72 transform overflow-hidden rounded-lg bg-white dark:bg-slate-800 shadow-md duration-300 hover:scale-105 hover:shadow-lg">
            <Image width={1980} height={1080}  class="h-48 w-full object-cover object-center" src={product?.imageUrl} placeholder='blur' blurDataURL={product?.base64Placeholder} alt="Product Image" />
            <div class="p-4">
